<template>
  <div>
    ...
    <!-- 添加物品信息 -->
    <el-dialog title="添加商品类型" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
            <span>
    ...
    <!-- 修改物品信息 -->
    <el-dialog title="修改商品类型" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
            <span>
